import { closeFiltersFull, FiltersState, initialState, setFilters } from "@/state";
        ...
        <AnimatePresence>
            {isFiltersFullOpen &&  (
                <motion.div
                    ...
                    className="fixed inset-0 bg-black/20 flex justify-start z-50"
                >
                    <AnimatePresence>
                        <motion.div 
                            ref={filterRef}
                        ...
                        >
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <Button 
                                    className="hover:bg-(--primary-700) text-black hover:!text-white rounded-xl"
                                    variant="outline"
                                    onClick={() => dispatch(closeFiltersFull())}
                                >
                                    Close
                                </Button>
                            </div>
                            <div className="flex flex-col space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <Button
                                            ...
                                            className="rounded-r-xl rounded-l-none border-l-none border-black shadow-none border hover:bg-(--primary-700) hover:text-(--primary-50) cursor-pointer"
                                        >
                                ...
                                <div className="flex gap-4 mt-6">
                                    <Button
                                        ...
                                        className="flex-1 bg-(--primary-700) text-white hover:text-(--primary-700) shadow-md rounded-xl"
                                    >
                                        Apply
                                    </Button>
                                    <Button
